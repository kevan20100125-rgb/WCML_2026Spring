...
from scipy.linalg import toeplitz, sqrtm, dft
from .utils import QAM_Modulation, QAM_Demodulation, lmmse_ce
from .EP import EP
...
def detector(sys, H, x, y, sigma2, MSE):
    ...
    if detect_type == 'CG_OAMP_NET' or detect_type == 'OAMP_NET' or detect_type == 'EPNet':  # use NET
